...
module CobolParser
  class ScannerTest < Test::Unit::TestCase
    def create_scanner
      ...
      scanner = Scanner.new(@context, options)

      @context.current_program = Tree::Program.new(@context, nil, 0)
 ...
 05 WRK-SYSYY PIC 9(04).
      EOS
        ...
        %w[
          ...
          n = name.upcase
          w = Word.new(name)
          @context.current_program.word_table[n] ||= []
          @context.current_program.word_table[n] << w
        end
        ...
        expected_tokens = [
          ...
          },
          {
            ...
            attributes: {
              category: :UNKNOWN,
              word: @context.current_program.word_table["01"].first,
            },
            line: 3,
          },
          {
            ...
            attributes: {
              category: :UNKNOWN,
              word: @context.current_program.word_table["WRK-AREA"].first,
            },
            line: 3,
          },
          {
          ...
          },
          {
            ...
            attributes: {
              category: :UNKNOWN,
              word: @context.current_program.word_table["03"].first,
            },
            line: 4,
          },
          {
            ...
            attributes: {
              category: :UNKNOWN,
              word: @context.current_program.word_table["WRK-SYSYMD"].first,
            },
            line: 4,
          },
          {
          ...
          },
          {
            ...
            attributes: {
              category: :UNKNOWN,
              word: @context.current_program.word_table["05"].first,
            },
            line: 5,
          },
          {
            ...
            attributes: {
              category: :UNKNOWN,
              word: @context.current_program.word_table["WRK-SYSYY"].first,
            },
            line: 5,
          },
          {
