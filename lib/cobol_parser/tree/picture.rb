...
# Picture
class CobolParser::Tree::Picture < CobolParser::Tree
  PIC_ALPHABETIC = 0x01
  PIC_NUMERIC = 0x02
  PIC_NATIONAL = 0x04
  PIC_EDITED = 0x08
  ...
  def initialize(context, attributes = {})
    ...
    begin
      parse_picture_string(attributes[:orig])
  ...
  def parse_picture_string(str) # rubocop:disable Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/MethodLength, Metrics/PerceivedComplexity
    ...
    when PIC_NUMERIC
      ...
      @cb.error("Numeric field cannot be larger than 36 digits") if digits > 36
